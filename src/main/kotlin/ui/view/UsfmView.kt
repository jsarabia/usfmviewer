...
import tornadofx.*
import ui.component.view.LanguageDrawer
import ui.component.view.TabButton
...
class UsfmView : View("Usfm Viewer") {
    ...
    init {
        languageTab = TabButton(messages["language"].capitalize(), languageIcon)
        bookTab = TabButton(messages["book"].capitalize(), bookIcon)
        chapterTab = TabButton(messages["chapter"].capitalize(), chapterIcon)
        settingsTab = TabButton(messages["settings"].capitalize(), settingsIcon)
